    ...
    <div>
            ...
            <div className="slider">
                <div className="slides">
                    ...
                    <div className="slide first">
                        <img src="https://i.ibb.co.com/NsMXPbT/trendshunters32868.jpg" alt="error"/>
                    </div>
                    <div className="slide">
        ...
        <div className="shopByRoom">
            ...
            <div className="Rooms">
                <div>
                    <a href="./products">
                        <img src="https://www.omsa.ru/upload/iblock/9b7/5b751p6l50tzqy856zx84wo0z7fk4wcq.jpg" alt="error"/>
                        <p>Shop Clothes</p>
                    </a>
                </div>
                <div>
                    <a href="./shoes">
                        <img src="https://www.omsa.ru/upload/iblock/65b/6pusadne14419pmcjqjnfjcarp6ryoyy.jpg    " alt="error"/>
                        <p>Shop Shoes</p>
                    </a>
                </div>
                <div>
                    <a href="./products">
                        <img src="https://www.omsa.ru/upload/iblock/064/29ykfw1gqbgs54p4o3311mmseoq22k4h.jpg" alt="error"/>
                        <p>Shop Underwear</p>
                    </a>
                </div>
                <div>
                    <a href="./shoes">
                        <img src="https://www.omsa.ru/upload/iblock/b66/bym32n6zqlv7q619sgtbo8ig2b5plas2.jpg" alt="error"/>
                        <p>Shop Socks</p>
                    </a>
                </div>
            </div>
        ...
        <div className="customers-speak">
            ...
            <div className="customers-card">
                ...
                <div>
                    <img src="https://i.ibb.co.com/rw1qs5x/Zhenskaya-kurtka-miaojie-lake-1400x950.jpg" alt="error"/>
                    <p>Маган унамады</p>
                    <p>Аружан 🍓</p>
